# YuumeiDKU music player - Powered by FFPlay - (c) Bionic Butter
...
function Show-Branding {
	...
	Write-Host "Music player module" -ForegroundColor Magenta -BackgroundColor Gray
	Write-Host " "
}

$host.UI.RawUI.WindowTitle = "Project YuumeiDKU - (c) Bionic Butter | Music player module"
Show-Branding
