...
Write-Host -ForegroundColor White "4. Notepad++" -n; Write-Host " (8.5)" -n;                   Show-Disenabled $NPP           
Write-Host -ForegroundColor White "5. ShareX (13.1.0)" -n;                                     Show-Disenabled $ShareX        
