...
$host.UI.RawUI.WindowTitle = "Project YuumeiDKU - (c) Bionic Butter | System Apps disabler module"
function Show-Branding {
	Clear-Host
	Write-Host 'Project YuumeiDKU - A New era for IDKUs' -ForegroundColor White -BackgroundColor Magenta
	Write-Host "System Apps disabler module" -ForegroundColor Magenta -BackgroundColor Gray
	Write-Host " "
}
Show-Branding
